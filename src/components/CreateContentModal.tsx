                            ...
                            <div className = "flex flex-col justify-between items-center gap-2">  
                                 ...
                                 <div className="flex items-center w-[90%] pt-5"> 
                                    ...
                                    <div className = "w-[98%] pb-7 gap-2">
                                         <h1 className = "text-[18px] text-slate-700 font-semibold">
                                        Add New Content
                                        </h1>
                                        <p className = "text-[15px] text-slate-500">Save a video, tweet, link, or quick note to your Mind Space.</p>
                                    </div>
                                   
                                     <ModelCrossContainer onClose={onClose}>
                                    {<RxCross2  className = "cursor-pointer text-slate-500 cursor"  size = {25}/>}
                                     </ModelCrossContainer> 
                                ...
                                <div className = "p-1 flex flex-col w-[90%]">
                                     ...
                                     <span className = "text-[12px] text-slate-400 mt-1">Keep it short and descriptive.</span>
                                </div>
                                <div className = "p-1 flex flex-col w-[90%]">
                                    ...
                                    <span className = "text-[12px] text-slate-400 mt-1">Paste the full URL. We’ll fetch a preview automatically.</span>
                                </div>
