          ...
          <ModelContentContainer>
            <div className="flex flex-col  items-center gap-1">
              <div className="flex items-center w-[90%] pt-5">
                <div className="w-[98%] pb-7 gap-2">
                  ...
                  <p className="text-[15px] text-slate-600">
                    Save a video, tweet, link, or quick note to your Mind Space.
                  </p>
                </div>
                ...
                <ModelCrossContainer onClose={onClose}>
                  {
                    <RxCross2
                      className="cursor-pointer text-slate-600 cursor"
                      size={25}
                    />
                  }
                </ModelCrossContainer>
              ...
              <div className="p-1 flex flex-col w-[90%]">
                ...
                <span className="text-[12px] text-slate-500 mt-1">
                  Paste the full URL. We’ll fetch a preview automatically.
                </span>
              </div>
            </div>
