    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-semibold text-gray-900">Mind Space</span>
        </div>
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <a href="/auth" className="text-sm font-medium text-gray-600 transition-colors hover:text-gray-900">
            Sign in
          </a>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-gray-600 sm:text-xl">
              Mind Space is your personal knowledge manager. Capture links, videos, tweets, and notes in seconds. Find them instantly when you need them.
            </p>
  ...
  const features = [
    {
      ...
      title: "Save Anything",
      description: "Capture links, notes, videos, and tweets instantly from anywhere on the web."
    },
    {
      icon: <Tag className="h-6 w-6" />,
      title: "Smart Organization",
      description: "Tag, filter, and categorize your content automatically with intelligent suggestions."
    },
    {
      icon: <Search className="h-6 w-6" />,
      title: "Fast Recall",
      description: "Find anything in milliseconds with powerful search across all your saved content."
    },
    {
      icon: <Layout className="h-6 w-6" />,
      title: "Clean Design",
      description: "A beautiful, distraction-free interface built for focus and clarity."
    }
  ];
      ...
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Built for people who value their ideas and want to keep them accessible.
          </p>
        </div>
  ...
  const steps = [
    {
      ...
      title: "Save",
      description: "Capture anything with our browser extension, mobile app, or email forwarding."
    },
    {
      icon: <Tag className="h-8 w-8" />,
      title: "Organize",
      description: "Let AI suggest tags and categories, or create your own custom organization system."
    },
    {
      icon: <Search className="h-8 w-8" />,
      title: "Recall",
      description: "Search instantly across everything you've saved and rediscover your best ideas."
    }
  ];

  return (
    <section id="how-it-works" className="bg-gradient-to-b from-gray-50 to-white px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative text-center">
              ...
              {index < steps.length - 1 && (
                <div className="absolute left-1/2 top-8 hidden h-0.5 w-full bg-gray-200 md:block" style={{ transform: 'translateX(50%)' }}></div>
              )}
            </div>
          ))}
        </div>
    ...
    <footer className="bg-white px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Join thousands of people who have organized their digital life with Mind Space.
          </p>
          <div className="mt-8">
